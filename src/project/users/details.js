	...
	return (
		<div className="container">
			...
			{currentUser?.role === 'ADMIN' && (
				<>
					<input onChange={(e) => setUser({ ...user, username: e.target.value })} type="text" value={user?.username} className="form-control" />
			...
			<div className="list-group">
				{followers.map((follows) => (
					<Link to={`/project/users/${follows.follower._id}`} key={follows._id} className="list-group-item">
			...
			<div className="list-group">
				{following.map((follows) => (
					<Link to={`/project/users/${follows.followed._id}`} key={follows._id} className="list-group-item">
